  ...
  return (
    <div className="container-page py-12 mt-20 px-6 md:px-8 lg:px-10">
      ...
      <p className="mt-3 max-w-2xl text-sm text-muted-foreground">
        Questions about schools, our methodology, or something else entirely? Drop us a note.
      </p>
      ...
      <div className="mt-12 grid gap-10 md:grid-cols-[1fr_1.2fr]">
        <div className="space-y-6">
          {[
            ...
            { icon: MapPin, label: "Office", value: "B-36, Nehru Colony, Dharampur, Dehradun" },
        ...
        <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
          {sent ? (
            <div className="py-10 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">We reply to every message within 48 hours.</p>
            </div>
          ) : (
            <form onSubmit={onSubmit} className="space-y-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  ...
                  <input name="phone" maxLength={20} className="mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
                </div>
                <div>
                  <label className="text-xs font-medium">Subject</label>
                  <input name="subject" maxLength={150} className="mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
                </div>
              </div>
              <div>
                <label className="text-xs font-medium">Message</label>
                <textarea name="message" required minLength={5} maxLength={2000} rows={5} className="mt-1 w-full rounded-lg border border-input bg-background px-3 py-2 text-sm" />
              </div>
