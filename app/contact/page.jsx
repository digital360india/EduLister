            ...
            <div className="flex flex-col items-center gap-2">
              <ul className=" w-full  p-5 sm:w-[270px] sm:h-[450px] lg:w-[750px] sm:p-9 lg:p-8  lg:h-[310px] flex flex-col gap-4 bg-white">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <div>edulisterindia@gmail.com</div>
                </li>
                ...
                <div className="flex justify-between">
                  <div className="flex gap-4 pt-5  ">
                    <a
                      href="https://www.instagram.com/edulister_india/?igsh=MWxkMzV5cDNndnplaQ%3D%3D"
                      target="_blank"
                    >
                      <BsInstagram className="w-5 h-5" />
                    </a>
                    <a
                      href="https://www.facebook.com/edulisterindia?mibextid=ZbWKwL"
                      target="_blank"
                    >
